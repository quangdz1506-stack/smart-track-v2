    ...
    <div className="flex items-center justify-center min-h-screen p-4 bg-background">
      <div className="glass-card w-full max-w-md p-8 rounded-3xl border border-outline-variant/30 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h2 className="text-center font-headline-lg font-bold text-primary mb-2">Create Account</h2>
          <p className="text-center text-on-surface-variant font-body-md mb-8">Join ExpensePro today</p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="flex flex-col gap-1">
              <label className="text-label-md text-on-surface ml-1">Username</label>
              <input 
                type="text" 
                required 
                value={username}
